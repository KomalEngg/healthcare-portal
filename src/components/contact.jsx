          ...
          <div className="flex flex-col lg:flex-row gap-12 items-stretch">
            ...
            <div className="lg:w-3/5 bg-white p-10 rounded-3xl shadow-lg border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-400 text-sm">Send us your query, we will reply within 24 hours.</p>
              </div>
...
>
            ...
            <div className="lg:w-2/5 min-h-[400px] rounded-3xl overflow-hidden shadow-lg border-4 border-white grayscale hover:grayscale-0 transition-all duration-700">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112108.35824424364!2d78.71186355447192!3d28.832961858022723!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390afbb26ad16075%3A0x3344654b9d0e163b!2sMoradabad%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1711200000000!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen="" 
